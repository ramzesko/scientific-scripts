...
files = [r'widmo1', r'widmo2', r'widmo3', r'widmo4']
data = []
values = []
...
for v in T:
    try:
        if v <= 2222:
            ...
            xplanck.append(x)
            yplanck.append(-0.9549476 * x**3 - 1.37418593 * x**2 + 2.09137015 * x - 0.16748867)
        else:
            x = (-3.0258469e9 / v/v/v + 2.1070379e6 / v/v + 0.2226347e3 / v + 0.24039)
            xplanck.append(x)
            yplanck.append(3.081758 * x**3 - 5.8733867 * x**2 + 3.75112997 * x - 0.37001483)
    except:
        pass
